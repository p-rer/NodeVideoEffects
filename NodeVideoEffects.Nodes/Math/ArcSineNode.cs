...
public class ArcSineNode : NodeLogic
{
    public ArcSineNode() : base(
        [
    ...
    {
        Outputs[0].Value = Convert.ToSingle(System.Math.Asin(Convert.ToDouble((float)(Inputs[0].Value ?? 0f))));
