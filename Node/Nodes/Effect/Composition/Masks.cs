...
public class CreateMaskNode : NodeLogic
{
    ...
    protected override Task Calculate()
    {
        ...
        if (_shaderId == Guid.Empty) _shaderId = VideoEffectsLoader.RegisterShader("MaskCreate");
...
public class MaskClipNode : NodeLogic
{
    ...
    protected override Task Calculate()
    {
        ...
        if (_shaderId == Guid.Empty) _shaderId = VideoEffectsLoader.RegisterShader("MaskClip");
...
public class MaskThresholdNode : NodeLogic
{
    ...
    protected override Task Calculate()
    {
        ...
        if (_shaderId == Guid.Empty) _shaderId = VideoEffectsLoader.RegisterShader("MaskThreshold");
