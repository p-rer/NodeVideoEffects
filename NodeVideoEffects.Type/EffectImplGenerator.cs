...
namespace NodeVideoEffects.Type
{
    public static class DynamicEffectImplGenerator
    {
        ...
        public static System.Type GenerateEffectImpl(List<(System.Type type, string name)> fields, string shaderId, ModuleBuilder moduleBuild)
        {
            ...
            for (var i = 0; i < fields.Count; i++)
            {
                ...
                var customEffectPropertyAttributeConstructor = typeof(CustomEffectPropertyAttribute).GetConstructor([typeof(PropertyType), typeof(int)]) ?? throw new InvalidOperationException("Cannot get the constructor");
            ...
            updateIl.Emit(OpCodes.Ldarg_0);
            updateIl.Emit(OpCodes.Ldfld, typeof(EffectImplBase).GetField("drawInformation", BindingFlags.Instance | BindingFlags.NonPublic)
            ...
            effectImplTypeBuilder.DefineMethodOverride(
                ...
                typeof(EffectImplBase).GetMethod("UpdateConstants", BindingFlags.NonPublic | BindingFlags.Public | BindingFlags.Instance,
                    System.Type.EmptyTypes)
                    ?? throw new InvalidOperationException("Cannot get the method \"UpdateConstants\"")
                );
        ...
        private static PropertyType GetPropertyType(System.Type type)
        {
